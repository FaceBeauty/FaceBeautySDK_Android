...
@Keep
public class FBPreviewRenderer {
    ...
    public FBPreviewRenderer(int imageWidth, int imageHeight) {
    ...
    public void create(boolean isFront) {
        ...
        program = FBGLUtils.loadProgram(vertexShaderSource, fragmentShaderSource);
