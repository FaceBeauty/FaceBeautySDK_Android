...
public class FBRoundImageView extends AppCompatImageView {
    ...
    public FBRoundImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FBRoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
