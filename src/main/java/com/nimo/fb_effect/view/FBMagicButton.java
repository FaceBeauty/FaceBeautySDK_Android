...
public class FBMagicButton extends AppCompatImageView implements Runnable {
    ...
    public FBMagicButton(Context context) {
        this(context, null);
    }

    public FBMagicButton(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FBMagicButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
